    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p><% if(session.getAttribute("id")!=null){%>
          ...
          <a class="btn btn-secondary my-2" onclick="DeleteAll()" >delete all</a>
...
for(int i=0; i<list.size(); i++){
	...
	s= s.trim();
	int num1=list.get(i).getPictureNum();
	
%>
       <form id="myform" name="frm" action="/J1/edit/Edit" method="get"> 
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <button type="button" class="btn btn-sm btn-outline-secondary" onclick ="Delete('num1')">delete</button>
                </div>
