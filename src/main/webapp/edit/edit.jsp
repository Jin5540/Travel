...
for(int i=0; i<list.size(); i++){
	...
	s= s.trim();
	int num=list.get(i).getPictureNum();
%>
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  ...
                  <input type="text" name="edit" placeholder="blah blah">
                 <input type="hidden" id="num" name="num" value=<%=num%>>
                  <button type="button" class="btn btn-sm btn-outline-secondary" onclick ="Edit('edit','num')">edit</button>
                  <%} %>
                </div>
